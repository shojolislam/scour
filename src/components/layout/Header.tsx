...
import { ScourLogo, SearchIcon, MenuIcon, CloseIcon } from "../ui/Icons";
...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-white flex items-center justify-between h-[60px]">
        {/* Logo */}
        <Link href="/" className="flex items-center px-5 py-4 shrink-0">
          <ScourLogo />
        </Link>

        {/* Center nav */}
        <nav className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-10">
          {navItems.map((item) => {
        ...
        {/* Right actions */}
        <div className="flex items-center gap-6 p-5 shrink-0">
          <button
