        ...
        <>
          ...
          >
            <div className="flex items-center gap-4 p-5">
              ...
              <input
                type="text"
                placeholder="Search by maker, type, location, material, dimensions"
                className="flex-1 text-[16px] text-[var(--color-text-default)] placeholder:text-[var(--color-text-subtle)] bg-transparent outline-none"
                autoFocus
              />
