    ...
    <div className="flex items-center justify-between p-4 w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="size-9 flex items-center justify-center border border-[var(--color-border)] cursor-pointer"
        >
        ...
        {visiblePages.map((page, i) =>
          page === null ? (
            ...
            <button
              ...
              className={`size-9 flex items-center justify-center text-[13px] font-medium uppercase cursor-pointer transition-all duration-200 ${
                currentPage === page
